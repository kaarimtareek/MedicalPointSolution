...
namespace MedicalPoint.Migrations
{
    ...
    [Migration("20230919132549_fixes_isfinished_medicine_batch_2")]
    partial class fixes_isfinished_medicine_batch_2
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("MedicalPoint.Data.MedicineBatch", b =>
                {
                    ...
                    b.Property<bool>("IsFinished")
                        ...
                        .HasColumnType("bit")
                        .HasComputedColumnSql("CAST(CASE Quantity  WHEN 0 THEN 1 ELSE 0 END AS bit)", true);
